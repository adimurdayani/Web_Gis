<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="col-sm-4">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <i class="fa fa-pencil"></i> Input Data Masyarakat
                </div>
                <div class="panel-body">
                    <?= $this->session->flashdata('msg');
                    ?>
                    <?= form_open_multipart('belakang/maskin/tbh_maskin') ?>
                    <div class="form-group">
                        <label>No. KK</label>
                        <input type="text" class="form-control" name="no_kk" id="no_kk" placeholder="Nomor KK" autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="luas_rumah" id="luas_rumah" placeholder="Luas Rumah">
                    ...
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea name="alamat" id="isi" cols="30" rows="10" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
