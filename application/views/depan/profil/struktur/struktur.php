...
<div class="container">
  ...
  <h1 class="mt-4 mb-3">Struktur Organisasi</h1>
  ...
  <div class="row">
    <div class="col-lg-6">
      <img class="img-fluid rounded mb-4" src="<?= base_url('assets/img/') . $get_struktur['gambar']; ?>" width="750px" alt="">
    </div>
    <div class="col-lg-6">
      <h2p><?= $get_struktur['judul']; ?></h2>
    </div>
  </div>
  <!-- /.row -->
